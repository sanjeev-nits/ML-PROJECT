...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            target_colomn = 'math score'
            numerical_column = ['writing score', 'reading score']
            
            input_feature_train_df = train_df.drop(columns=[target_colomn], axis=1)
            target_feature_train_df = train_df[target_colomn]
            
            input_feature_test_df = test_df.drop(columns=[target_colomn], axis=1)
            target_feature_test_df = test_df[target_colomn]
